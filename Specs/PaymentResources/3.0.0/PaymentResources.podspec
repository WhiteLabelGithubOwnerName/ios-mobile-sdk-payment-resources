Pod::Spec.new do |s|
  ...
  s.source           = { :http => 'https://github.com/WhiteLabelGithubOwnerName/ios-mobile-sdk-payment-resources/raw/master/Specs/PaymentResources/3.0.0/PaymentResourcesDynamic.zip'}
